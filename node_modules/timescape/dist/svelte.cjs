...
__export(svelte_exports, {
  NOW: () => $NOW,
  createTimescape: () => createTimescape,
  createTimescapeRange: () => createTimescapeRange
});
...
var createTimescape = (options = {}) => {
  const optionsStore = (0, import_store.writable)(options);
