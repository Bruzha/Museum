...
class Video{
    ...
    init(){
        if(document.querySelector('.overlay-id-0') !== null) {
            document.querySelector('.overlay-id-0').addEventListener('click', () => this.videoClick('https://www.youtube.com/embed/aWmJ5DgyWPI?si=H85tY1qiikp8xfTx'));
        }
        
        if(document.querySelector('.overlay-id-1') !== null) {
            document.querySelector('.overlay-id-1').addEventListener('click', () => this.videoClick('https://www.youtube.com/embed/Vi5D6FKhRmo?si=WhHSVVS17bNR0Rx9'));
        }
        if(document.querySelector('.overlay-id-2') !== null) {
            document.querySelector('.overlay-id-2').addEventListener('click', () => this.videoClick('https://www.youtube.com/embed/NOhDysLnTvY?si=5t7R4CF4vOVp_k1n'));
        }
        if(document.querySelector('.overlay-id-3') !== null) {
            document.querySelector('.overlay-id-3').addEventListener('click', () => this.videoClick('https://www.youtube.com/embed/VVj-2Jdtl4o?si=2eQCWj_A3kqzbJEu'));
        }
        if(document.querySelector('.overlay-id-4') !== null) {
            document.querySelector('.overlay-id-4').addEventListener('click', () => this.videoClick('https://www.youtube.com/embed/zp1BXPX8jcU?si=Zy4Job7HFMv4NsT5'));
        }
