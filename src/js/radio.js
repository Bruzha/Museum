...
items.push(
  <iframe
    class='frame'
    src='https://www.youtube.com/embed/T65C91rTjn0?si=_Qn_fBSpj6xNOGTA'
...
items.push(
  <iframe
    class='frame'
    src='https://www.youtube.com/embed/VVj-2Jdtl4o?si=qD8JeKHZEh9ZFVQ7'
    title='YouTube video player'
    frameborder='0'
    allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share'
    referrerpolicy='strict-origin-when-cross-origin'
...
function updateCarousel() {
  const offset = -currentIndex * 100;
  document.querySelector('.frame').style.transform = `translateX(${offset}%)`;
